...
+ (NSString *)signatureBaseStringUsingParameterString:(NSString *)inParameterString forRequest:(MPOAuthURLRequest *)inRequest {
	return [NSString stringWithFormat:@"%@&%@&%@",	[inRequest HTTPMethod],
      [DBNSString string:[DBNSURL absoluteNormalizedString:inRequest.url] byAddingURIPercentEscapesUsingEncoding:NSUTF8StringEncoding],
          [DBNSString string:inParameterString byAddingURIPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
}
