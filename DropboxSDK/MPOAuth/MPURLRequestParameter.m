...
- (NSString *)URLEncodedParameterString {
  return [NSString stringWithFormat:@"%@=%@", [DBNSString string:self.name byAddingURIPercentEscapesUsingEncoding:NSUTF8StringEncoding], self.value ? [DBNSString string:self.value byAddingURIPercentEscapesUsingEncoding:NSUTF8StringEncoding] : @""];
}
