...
- (UIView*)tableView:(UITableView*)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if (headerView == nil) {
        headerView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"modules/com.0x82.dropbox/db_link_header.png"]];
...
- (UIView*)tableView:(UITableView*)tableView viewForFooterInSection:(NSInteger)section {
    ...
    if (footerView == nil) {
        ...
        [createButton setImage:[UIImage imageNamed:@"modules/com.0x82.dropbox/db_create_account_button.png"] 
                forState:UIControlStateNormal];
        [createButton setImage:[UIImage imageNamed:@"modules/com.0x82.dropbox/db_create_account_button_down.png"]
