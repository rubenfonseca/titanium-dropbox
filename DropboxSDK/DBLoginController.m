...
- (void)viewDidLoad {
    ...
    UIImageView* background = 
        [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"modules/com.0x82.dropbox/db_background.png"]];
    ...
    UIImageView* logo = 
        [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"modules/com.0x82.dropbox/db_logo.png"]];
    ...
    [createAccountButton 
        setImage:[UIImage imageNamed:@"modules/com.0x82.dropbox/db_create_account.png"] 
...
- (UIView*)tableView:(UITableView*)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if (!descriptionLabel) {
        descriptionLabel = 
            [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"modules/com.0x82.dropbox/db_link_header.png"]];
...
- (UIView*)tableView:(UITableView*)tableView viewForFooterInSection:(NSInteger)section {
    ...
    if (footerView == nil) {
        ...
        [linkButton addTarget:self action:@selector(didPressLogin) 
                forControlEvents:UIControlEventTouchUpInside];
        [linkButton setImage:[UIImage imageNamed:@"modules/com.0x82.dropbox/db_link_button.png"]
                forState:UIControlStateNormal];
        [linkButton setImage:[UIImage imageNamed:@"modules/com.0x82.dropbox/db_link_button_down.png"]
